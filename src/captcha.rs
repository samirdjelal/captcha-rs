 ...
 */
fn cyclic_write_character(res: &[String], image: &mut ImageBuffer<Rgb<u8>, Vec<u8>>, dark_mode: bool) {
...
fn draw_interference_line(image: &mut ImageBuffer<Rgb<u8>, Vec<u8>>, dark_mode: bool) {
	...
	draw_cubic_bezier_curve_mut(image, (x1, y1), (x2, y2), (ctrl_x, ctrl_y), (ctrl_x2, ctrl_y2), get_color(dark_mode));
}
 ...
 *        image  - Background picture
 */
fn draw_interference_ellipse(num: usize, image: &mut ImageBuffer<Rgb<u8>, Vec<u8>>, dark_mode: bool) {
	for _ in 0..num {
